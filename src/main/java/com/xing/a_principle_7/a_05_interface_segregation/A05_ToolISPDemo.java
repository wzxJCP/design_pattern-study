...
/**
 * 接口隔离原则（ISP）的核心一句话总结：
 * 客户端不应被迫依赖于它不需要的接口，应将臃肿的“万能接口”拆分为更小、更具体的“专用接口”。
 * 结合代码理解：
 * 就像工具代码一样，SawWorker（客户端）明明只需要锯木头，如果强迫它依赖 SuperTool（万能接口），
 * 它就不得不去实现毫无意义的 screw() 和 hammer() 方法，造成了代码冗余和污染。而遵循 ISP 后，
 * 木工只依赖 Saw 接口，钳工只依赖 ScrewDriver 接口，“术业有专攻”，各司其职，互不干扰。
 *
 * 各个人只负责自己的工作，不搞万能工具！
 */